...
<head>
	...
	<link rel="stylesheet" href="../css/calcStyleFr.css"/>
</head>
<body id="calculator">
	<div id="test">
	...
	<? include("../includes/headerFR.html"); ?>

	<div id="container">
		<div id="calculatormain">
			<div id="calcintro">
				<img id="calculatorTitleImage" src="../img/calculator/earnMoreTitle_fr.png" width="541" height="16" alt="EARN MORE WITH AN AIR MILES&reg; CREDIT CARD"/>
				<p>Une carte de cr&eacute;dit AIR MILES vous permet d'accumuler sur tout et vous rapporte aussi DEUX FOIS chez les commanditaires AIR MILES.</p>
			</div>
			<div id="calculator">
				<div id="calculatorFormTop">
					<p id="findout">D&eacute;couvrez combien vous accumuleriez en plus avec une carte de cr&eacute;dit AIR MILES.</p>
				</div>
				<div id="calculatorContent" class="clearfix">
					<div id="calculatorForm">
						<div>
							<div class="qlabel">
								<img src="../img/calculator/one.png" alt="1"/><p>Choisir une carte de cr&eacute;dit</p>
							</div>
							<select id="cardSelect" class="styled-select">
								<option value="amexFee">Carte de cr&eacute;dit de Platine AIR MILESmd American ExpressMD*</option>
								<option value="amexNoFee">Carte de cr&eacute;dit AIR MILESmd American ExpressMD*</option>
								<option value="bmoFee">Carte MasterCardMD* BMOMD&dagger; AIR MILES World</option>
								<option value="bmoNoFee">Carte MasterCardMD* BMOMD&dagger; AIR MILES</option>
							</select>
						</div>
						<img class="hr" src="../img/calculator/hr.png" width="287" height="2"/>
						<div>
							<div class="qlabel">
								<img src="../img/calculator/two.png" alt="2"/><p>Choisir la r&eacute;gion</p>
							</div>
							<select id="provdrop">
								<option value="ab">Alberta</option>
								<option value="bc">Colombie britannique</option>
								<option value="mb">Manitoba</option>
								<option value="nfld">Terre-Neuve-et-Labrador</option>
								<option value="nb">Nouveau-Brunswick</option>
								<option value="sk">Saskatchewan</option>
								<option value="nwt">(territoires du) Nord-Ouest</option>
								<option value="ns">Nouvelle-&Eacute;cosse</option>
								<option value="nu">Nunavut</option>
								<option value="on">Ontario</option>
								<option value="pei">l'&icirc;le du Prince-&Eacute;douard</option>
						...
						<div id="calculatorSliders">
							<div class="qlabel">
								<img src="../img/calculator/three.png" alt="3"/><p>Combien d&eacute;pensez-vous en moyenne par mois sur les achats &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;suivants :</p>
							</div>
							<div id="groceryInput" class="spendSlider">
								<h2 class="sliderlabel">&Eacute;picerie</h2>
							...
							<div id="gasInput" class="spendSlider">
								<h2 class="sliderlabel">Essence</h2>
								<div class="slideHolder">
							...
							<div id="pharmacyInput" class="spendSlider">
								<h2 class="sliderlabel">Pharmacie</h2>
								<div class="slideHolder">
							...
							<div id="hardwareInput" class="spendSlider">
								<h2 class="sliderlabel">Quincaillerie</h2>
								<div class="slideHolder">
							...
							<div id="liquorInput" class="spendSlider">
								<h2 class="sliderlabel">Alcool</h2>
								<div class="slideHolder">
							...
							<div id="otherInput" class="spendSlider">
								<h2 class="sliderlabel">Autres achats</h2>
								<div class="slideHolder">
						...
						<img class="hr" src="../img/calculator/hr.png" width="287" height="2"/>
						<div class="qlabel">
							<img src="../img/calculator/four.png" class="noWrapq4" alt="4"/><p id="spendqblurb">Quel pourcentage d&eacute;pensez-vous chez des commanditaires &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AIR&nbsp;MILES? </p>
						</div>
						<select id="oftenshop">
							<option value="100">Tout (100%)</option>
							<option value="75">La plupart (75%)</option>
							<option value="50">La moiti&eacute; environ (50%)</option>
							<option value="25">Un peu (25%)</option>
							<option value="0">Rien (0%)</option>
						</select>
					</div>
					<div id="barGraph">
						<img  src="../img/calculator/bargraphTitle_fr.png" id="bargraphTitle" width="174" height="24" alt="YOUR AIR MILES REWARD MILES PER YEAR">
				...
				<div id="bmoCalcSalesLine" style="display:none;">
					<p>La carte MasterCard&nbsp;BMO AIR&nbsp;MILES vous rapporte 25 % de milles de r&eacute;compense en plus chez Shell</p>
				</div>
				<div id="amexNoFeeCalcSalesLine" style="display:none;">
					<p>1 mille de r&eacute;compense par tranche de 15 $ d'achats port&eacute;s &agrave; la Carte chez les commanditaires AIR&nbsp;MILES.<p>
				</div>
				<div id="amexFeeCalcSalesLine" style="display:none;">
					<p>1 mille de r&eacute;compense par tranche de 10 $ d'achats port&eacute;s &agrave; la Carte chez les autres d&eacute;taillants admissibles en essence,<br/>&eacute;picerie et pharmacie.<p>
				</div>
			</div>
			<div id="calcSalesLeadout">
				<p>DEMANDEZ UNE <span id="cardNameDisplay"></span> POUR ACCUMULER PLUS</p>
				<a href="#" target="_blank"><img src="../img/calculator/learnMore_fr.png" alt="learn more"/></a>
			</div>
		</div>

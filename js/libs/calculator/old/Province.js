function Province(base, amexfee_sponsor, amexfee_nonsponsor, amexnofee_sponsor, amexnofee_nonsponsor, bmofee_sponsor, bmofee_nonsponsor, bmonofee_sponsor, bmonofee_nonsponsor){
	...
	this.findBmoFeeMiles = function(sponsorPercent){
		...
		milesReturn.sponsor.gas = this.baseMiles.gas*1.25;//this.getMiles(calculator.spend.gas,this.bmofee_sponsor.gas);
		console.log("gas:"+this.baseMiles.gas);
		console.log("bmo fee:"+milesReturn.sponsor.gas);
	...
	this.findBmoNoFeeMiles = function(sponsorPercent){
		...
		milesReturn.sponsor.gas = this.baseMiles.gas*1.25;//this.getMiles(calculator.spend.gas,this.bmonofee_sponsor.gas);
